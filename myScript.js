...
function selectValue(){
    ...
    if(faculty == "C.S.E"){
        ...
        dept.options[1] = new Option('Department of Information Technology')
        dept.options[2] = new Option('Department of Computer Science & Engineering')
        dept.options[3] = new Option('Department of CSCE')

    } else if(faculty == "Management"){
        dept.options.length = 0
        dept.options[0] = new Option('Choose Department...')
        dept.options[1] = new Option('Department of BBA')
        dept.options[2] = new Option('Department of MBA')
        ...
        dept.options.length = 0
        dept.options[0] = new Option('Choose Department...')
        dept.options[1] = new Option('Department of Civil Engineering')
        ...
        dept.options.length = 0
        dept.options[0] = new Option('Choose Department...')
        dept.options[1] = new Option('Department of B.Arch')
